...
@EnableJpaRepositories(entityManagerFactoryRef = "bookEntityManageFactory", basePackages = {
		"in.shambhu.book.repository" }, transactionManagerRef = "bookTransactionManager")
public class BookDBConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactoryBeanBuilder(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(datasource).properties(properties).packages("in.shambhu.model.book")
